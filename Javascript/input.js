...
// function verificar() {
//   let valor1 = document.querySelector(`input#numero1`).value;
//   let valor2 = document.querySelector(`input#numero2`).value;
//   let valor3 = document.querySelector(`input#numero3`).value;
//   let resultado = document.querySelector(`div#res`);
//   let soma1 = Number(valor1) + Number(valor2);
//   let soma2 = soma1 * Number(valor3);
//   resultado.innerHTML = `A soma entre os numeros ${valor1} + ${valor2} é igual a ${soma1},<br> e multiplicado por ${valor3} é igual a ${soma2}`;
// }
...
function verificar(){
  ...
  resoluçao.innerHTML = `A soma entre os numeros ${valor1} + ${valor2} é igual a: ${soma1},<br> e multiplicado por ${valor3} é igual a: ${soma2}`
